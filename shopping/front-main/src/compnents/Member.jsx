...
function Regist() {
    ...
    const [dob, setDob] = useState("");  // YYYY-MM-DD 형식으로 받음
    ...
    if (!dob) return alert("생년월일을 선택해 주세요");
    // 밑에 있는거 대산애 dob로 바꿈
    // if (!year)
        ...
        <div>
            ...
            <br />
             ...
             생년월일 :   <input type="date"  value={dob} onChange={(e) => setDob(e.target.value)}/>
                         {/* <input type="text" placeholder="YYYY" maxLength="4" value={year} onChange={handleYearChange}/> 
